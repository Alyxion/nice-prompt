...
- **value_events.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/events/value_events.md`): on_change, on_value_change for inputs, selects, sliders; ValueChangeEventArguments
- **button_events.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/events/button_events.md`): on_click for buttons; ClickEventArguments
- **element_events.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/events/element_events.md`): Generic DOM events: on('click'), on('mouseover'), etc.
- **lifecycle_events.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/events/lifecycle_events.md`): app.on_startup, app.on_shutdown, app.on_connect, app.on_disconnect
- **keyboard_events.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/events/keyboard_events.md`): ui.keyboard for global key events; KeyEventArguments
- **upload_events.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/events/upload_events.md`): on_upload, on_rejected for file uploads; UploadEventArguments

### Class Reference

- **controls.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/classes/controls.md`): ui.button, ui.input, ui.select, ui.checkbox, ui.switch, ui.slider, ui.toggle, ui.radio, ui.number, ui.textarea, ui.date, ui.time, ui.upload, ui.color_input
- **layout.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/classes/layout.md`): ui.row, ui.column, ui.card, ui.grid, ui.expansion, ui.tabs, ui.dialog, ui.menu, ui.splitter, ui.scroll_area, ui.header, ui.footer, ui.drawer
- **text_elements.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/classes/text_elements.md`): ui.label, ui.markdown, ui.html, ui.link, ui.badge, ui.chip, ui.tooltip, ui.notify
- **data_elements.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/classes/data_elements.md`): ui.table, ui.aggrid, ui.echart, ui.plotly, ui.highchart, ui.tree, ui.log, ui.json_editor, ui.code
- **audiovisual.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/classes/audiovisual.md`): ui.image, ui.interactive_image, ui.video, ui.audio, ui.icon, ui.avatar, ui.scene (3D), ui.leaflet (maps)
- **app_and_config.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/classes/app_and_config.md`): app.storage (browser/user/general), app.on_startup/shutdown, ui.run() config, ui.dark_mode, ui.colors
- **utilities.md** (`https://github.com/Alyxion/nice-prompt/blob/main/docs/classes/utilities.md`): ui.timer, ui.keyboard, ui.download, ui.navigate, ui.run_javascript, ui.context, background_tasks
